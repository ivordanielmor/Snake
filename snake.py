...
# 2) Pandas-elemzés: napi összeg + kumulált pont + 3-as gördülő átlag
# Hozz létre külön elemző scriptet, hogy a játék kódja tiszta maradjon.

# Ha nem lenne világos, egy külön fájlt kell létrehozni! analyze_scores_pandas.py 
